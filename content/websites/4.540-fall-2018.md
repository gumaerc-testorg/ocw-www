...
course_description: Shape grammars are systems of visual rules by which one shape
  ...
  More specifically, it involves manipulation of shapes in the algebras \\(U\_{ij}\\),
  in the algebras \\(V\_{ij}\\) and \\(W\_{ij}\\) incorporating labels and weights,
  and in algebras formed as composites of these. Discussions center on rules and computations,
  shape and structure, and designs.
course_image:
...
uid: 8779d159-2aec-4bcf-b93c-eeb0c2fae0b4
